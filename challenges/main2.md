...
- To be considered for winning, and for 250 OCEAN reward for a valid submission, prediction error must be lower than (a) if the "prediction" was simply a constant (b) if the prediction was a copy of any of the end-to-end examples 
