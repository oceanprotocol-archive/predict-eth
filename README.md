...
- [Predict ETH price for any given hour of the day using Ocean data an a linear model: An example ready to be submitted](examples/ready-submit-eth-ocean-data-linear-model.md)
